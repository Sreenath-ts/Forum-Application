...
const corsOptions = {
    ...
    app.use(cors({
    origin: ['https://glittering-dodol-08c860.netlify.app','http://localhost:4200']
  }));
...
const io = socketIO(server, {
  cors: {
    origin: ["https://admin.socket.io","https://codemonk-ywey.onrender.com","https://glittering-dodol-08c860.netlify.app","http://localhost:4200"],
    credentials: true
  }
});
